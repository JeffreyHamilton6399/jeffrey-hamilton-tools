...
function PrivacyBody() {
  return (
    <>
      <p>
        This page describes what Jeffrey Hamilton Tools does with what you give it, and what it
        does not do.
      </p>

      <h3>Your data stay on your device</h3>
      <p>Jeffrey Hamilton Tools is a static page. It has no upload form, no input box, and no server-side processing, there is nothing for it to see.</p>
      <p>Each tool it links to follows the same rule: your data stays on your device.</p>

      <h3>No accounts, no tracking identifiers</h3>
      <p>
        Jeffrey Hamilton Tools does not require sign-up and does not use accounts. It sets no
      ...
      <ul>
        <li>Your theme preference (light or dark), stored locally in your browser.</li>
      </ul>
      <p>
        Closing the tab discards everything from memory. Nothing is written to
        disk by Jeffrey Hamilton Tools itself beyond what you explicitly save.
      </p>

      <h3>Analytics</h3>
      <p>
        Jeffrey Hamilton Tools includes no third-party analytics and no advertising trackers.
      ...
      <p>
        Jeffrey Hamilton Tools is a general-purpose utility and does not knowingly collect
      ...
      <h3>Contact</h3>
      <p>
        Jeffrey Hamilton Tools is open source. For questions about this policy, email{" "}
        <a
...
function TermsBody() {
  return (
    <>
      <p>
        By using Jeffrey Hamilton Tools, you agree to these terms. They’re short on purpose.
      </p>

      <h3>The service</h3>
      <p>
        Jeffrey Hamilton Tools is a directory of free, privacy-first browser tools. It is provided “as is” and “as available”,
      ...
      <ul>
        <li>Don’t use Jeffrey Hamilton Tools for anything you don’t have the right to do.</li>
      ...
      <h3>Free and open</h3>
      <p>
        Jeffrey Hamilton Tools is free to use. There are no paid tiers, no watermarks, and no
      ...
      <p>Jeffrey Hamilton Tools is built on open-source libraries, each governed by its own license. The full list lives in the project’s package.json on GitHub.</p>

      <h3>Changes</h3>
      <p>
        These terms may be updated from time to time. Continued use of
        Jeffrey Hamilton Tools after a change constitutes acceptance of the updated terms.
      </p>
    </>
  );
}
